...
# python3 ./prompt_engineering/predict.py --nn_name EleutherAI/gpt-neox-20b --dset_name 'spot' \
#     --prompt_style 'yes_no' --parse_output_method 'rule_based' \
#     --k_shot "0" --ensemble_size "1" --remove_public_health \
#     --batch_size "1" &&

# python3 ./prompt_engineering/predict.py --nn_name EleutherAI/gpt-neox-20b --dset_name 'spot' \
#     --prompt_style 'yes_no' --parse_output_method 'rule_based' \
#     --k_shot "2" --ensemble_size "1" --remove_public_health \
#     --batch_size "1" &&
...
# python3 ./prompt_engineering/predict.py --nn_name EleutherAI/gpt-neox-20b --dset_name 'spot' \
#     --prompt_style 'yes_no' --parse_output_method 'language_model_generation' \
#     --k_shot "0" --ensemble_size "1" --remove_public_health \
#     --batch_size "1" &&
...
# python3 ./prompt_engineering/predict.py --nn_name EleutherAI/gpt-neox-20b --dset_name 'spot' \
#     --prompt_style 'open' --parse_output_method 'language_model_perplexity' \
#     --k_shot "0" --ensemble_size "1" --remove_public_health \
#     --batch_size "1" &&
...
python3 ./prompt_engineering/predict.py --nn_name EleutherAI/gpt-neox-20b --dset_name 'spot' \
    --prompt_style 'pilestackoverflow_open' --parse_output_method 'language_model_perplexity' \
    --k_shot "0" --ensemble_size "1" --remove_public_health \
    --batch_size "1" &&
...
# Open-ended Variants with Language Model Output Parsing (language_model_generation) and PileStackOverflow formatting
python3 ./prompt_engineering/predict.py --nn_name EleutherAI/gpt-neox-20b --dset_name 'spot' \
    --prompt_style 'pilestackoverflow_open' --parse_output_method 'language_model_generation' \
    --k_shot "0" --ensemble_size "1" --remove_public_health \
    --batch_size "1" &&
