...
train_dset.to_csv('./data/spot/spot_indicator_mapping_table_train.csv', index=False)
test_dset.to_csv('./data/spot/spot_indicator_mapping_table_test.csv', index=False)