...
categories = pd.read_csv('/Users/oguerrero/Library/CloudStorage/Dropbox/Projects/ppi4health/data/england/deprivation/clean_data/spot_indicator_mapping_table.csv', encoding = 'unicode_escape')
