...
df = pd.read_csv(home+'data/england/deprivation/clean_data/pipeline_indicators_normalized.csv', encoding='unicode_escape')
...
dff.to_csv(home+'data/england/deprivation/clean_data/network.csv', index=False)
